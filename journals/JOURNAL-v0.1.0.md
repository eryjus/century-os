# The Century OS Development Journal - v0.1.0

## Version 0.1.0

This journal will take the development from the inception of this project to a functioning i686 micro-kernel which has scheduling and some light-weight messaging.  It also has processes running in user mode.
